...
![](public/assets/pprof-manual/images/http-debug-pprof.png)
...
![](public/assets/pprof-manual/images/interpret-callgraph.png)
...
![](public/assets/pprof-manual/images/web-interface.png)
...
![](public/assets/pprof-manual/images/flame-graph.png)
...
![](public/assets/pprof-manual/images/view-callers.png)

####  Annotated Source Code

右击函数 `FormatUntype` ，可以看到有些可选项：

![](public/assets/pprof-manual/images/annotated-source-code.png)

选择 `Show source in new tab`，这将在新的标签页展示该函数被适当注释后的源代码。

![](public/assets/pprof-manual/images/source-code.png)
...
![](public/assets/pprof-manual/images/click-line-207.png)
...
![](public/assets/pprof-manual/images/disassembly.png)
#### Top Functions

有时，您可能会发现仅显示配置文件中顶部函数的表格很有帮助：

![](public/assets/pprof-manual/images/top-funcs.png)
